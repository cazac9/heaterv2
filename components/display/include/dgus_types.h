...
enum variables {
  DSUG_VAR_TIME = 0x009c,
  DGUS_VAR_T_TEMP = 0x1000,
  DGUS_VAR_C_TEMP = 0x1001,
  DSUG_VAR_WTRFLOW = 0x1002,
  DSUG_VAR_IS_ON = 0x2001,
  DSUG_VAR_HSTATE1_UPDATED = 0x2002,
  DSUG_VAR_HSTATE2_UPDATED = 0x2003,
  DSUG_VAR_HSTATE3_UPDATED = 0x2004,
  DSUG_VAR_IS_HEATING = 0x3000,
  DSUG_VAR_WIFI = 0x3001,
  DSUG_VAR_HSTATE1_SET = 0x3002,
  DSUG_VAR_HSTATE2_SET = 0x3003,
  DSUG_VAR_HSTATE3_SET = 0x3004
};
